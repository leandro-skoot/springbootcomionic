package com.leandroskoot.cursomc.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validationIntegrity(MethodArgumentNotValidException e, HttpServletRequest request){
